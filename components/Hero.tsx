      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          <p className="text-xl text-slate-400 mb-10 max-w-2xl font-light leading-relaxed">
            LexiPro accelerates discovery in complex medical liability litigation.
            Unified ingestion of EHR data, depositions, and communications—validated by deterministic evidence anchoring.
          </p>
          ...
          <div className="mb-10">
            <div className="flex flex-wrap gap-2">
              {[
                ...
                "Anchors-Required Enforcement",
                "Secure Deployment Ready",
              ].map((item) => (
                <span
                  key={item}
                  className="inline-flex items-center px-3 py-1 rounded-full bg-slate-800/60 border border-slate-700 text-xs text-slate-200 tracking-wide"
                >
                  {item}
                </span>
              ))}
            ...
            <p className="text-xs text-slate-500 mt-3 max-w-2xl">
              Public demo runs a simulated forensic engine — no client-side secrets, no external AI keys.
            </p>
          </div>
