        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-8 bg-slate-800/50 border border-slate-700 rounded-sm hover:border-blue-500/50 transition-colors group">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h3 className="text-lg font-medium text-white">Anchoring Compliance</h3>
            </div>
            <div className="text-5xl font-mono font-bold text-white mb-2">0%</div>
            <p className="text-slate-400 text-sm">Unanchored outputs permitted. Every generated finding must map to an evidence anchor before it can be surfaced.</p>
          </div>
        </div>
      </div>
    </section>
